...
namespace LoanManagement.dao
{
    public class LoanRepositoryImpl : ILoanRepository
    {
        ...
        {
            using (SqlConnection connection = DBConnectUtil.GetConnection())
            {
                ...
                using (SqlCommand cmd = new SqlCommand(query, connection))
                {
                    ...
                    {
                        ApplyHomeLoan(homeLoan, loanId, connection);
                    }
                    else if (loan is CarLoan carLoan)
                    {
                        ApplyCarLoan(carLoan, loanId, connection);
                    }
        ...
        private void ApplyHomeLoan(HomeLoan loan, int loanId, SqlConnection connection)
        {
        ...
        private void ApplyCarLoan(CarLoan loan, int loanId, SqlConnection connection)
        {
